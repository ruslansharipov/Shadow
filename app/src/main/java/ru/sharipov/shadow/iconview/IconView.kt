package ru.sharipov.shadow.iconview
...
//    private var smallBlurShadow: Bitmap? = null
    ...
    private var constantShadowTranslationY = 8f //8
    private var variableShadowTranslationY = 16f //16
    private var scaleDown = 0.9f
    private var bigBlurRadius = 20f
//    private var smallBlurRadius = 8f
    ...
    init {
        ...
        constantShadowTranslationY = a.getDimension(
            R.styleable.IconView_constantShadowTranslationY,
            constantShadowTranslationY
        )
        variableShadowTranslationY = a.getDimension(
            R.styleable.IconView_variableShadowTranslationY,
